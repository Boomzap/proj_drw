...
namespace UnityEditor.U2D.PSD
{
    ...
    /// </summary>
    [ScriptedImporter(4, "psb", AllowCaching = true)]
    ...
    public class PSDImporter : ScriptedImporter, ISpriteEditorDataProvider
    {
        ...
        public List<TextureImporterPlatformSettings> PlatformSettings { get => m_PlatformSettings; }
        [SerializeField]
        ...
        void ImportFromLayers(AssetImportContext ctx, Document doc)
        {
            ...
            try
            {
                ...
                // override to use our modified version
                Boomzap.Utilities.BZImagePacker.Pack(layerBuffers.ToArray(), doc.width, doc.height, padding, out output, out width, out height, out spritedata, out uvTransform);
                var spriteImportData = GetSpriteImportData();
