...
public sealed class Mathfx
{
    ...
    public static Color Hermite(Color start, Color end, float value)
    {
        return new Color(Hermite(start.r, end.r, value), Hermite(start.g, end.g, value), Hermite(start.b, end.b, value), Hermite(start.a, end.a, value));
    }
